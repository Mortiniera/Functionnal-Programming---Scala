...
class LispSuite extends FunSuite {
 ...
 //Added test for Lisp comprehension
  testLisp("FindLastElem", List(0), LispCode.lastElem("(mylast (cons 2 (cons 1 (cons 0 nil))))"))
  testLisp("FindkthElemoflist", 2, LispCode.kth("(kthelem (cons 4 (cons 3 (cons 2 (cons 1 (cons 0 nil))))) 2)"))
